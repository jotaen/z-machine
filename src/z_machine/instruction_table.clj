...
(defn instruction-table [byte]
  (case byte
    ...
    (0x01 0x21 0x41 0x61 0xc1) { :name :je }
    (0x02 0x22 0x42 0x62 0xc2) { :name :jl }
    (0x03 0x23 0x43 0x63 0xc3) { :name :jg }
    (0x04 0x24 0x44 0x64 0xc4) { :name :dec_chk }
    (0x05 0x25 0x45 0x65 0xc5) { :name :inc_chk }
    (0x06 0x26 0x46 0x66 0xc6) { :name :jin }
    (0x07 0x27 0x47 0x67 0xc7) { :name :test }
    (0x08 0x28 0x48 0x68 0xc8) { :name :or }
    (0x09 0x29 0x49 0x69 0xc9) { :name :and }
    (0x0a 0x2a 0x4a 0x6a 0xca) { :name :test_attr }
    ...
    (0x0f 0x2f 0x4f 0x6f 0xcf) { :name :loadw }
    (0x10 0x30 0x50 0x70 0xd0) { :name :loadb }
    (0x11 0x31 0x51 0x71 0xd1) { :name :get_prop }
    (0x12 0x32 0x52 0x72 0xd2) { :name :get_prop_addr }
    (0x13 0x33 0x53 0x73 0xd3) { :name :get_next_prop }
    (0x14 0x34 0x54 0x74 0xd4) { :name :add }
    (0x15 0x35 0x55 0x75 0xd5) { :name :sub }
    (0x16 0x36 0x56 0x76 0xd6) { :name :mul }
    (0x17 0x37 0x57 0x77 0xd7) { :name :div }
    (0x18 0x38 0x58 0x78 0xd8) { :name :mod }
    (0x19 0x39 0x59 0x79 0xd9) { :name :call_2s }
    ...
    ; 1OP, all short
    ; L  | S  | V
    (0x80 0x90 0xa0) { :name :jz }
    (0x81 0x91 0xa1) { :name :get_sibling }
    (0x82 0x92 0xa2) { :name :get_child }
    (0x83 0x93 0xa3) { :name :get_parent }
    (0x84 0x94 0xa4) { :name :get_prop_len }
    (0x85 0x95 0xa5) { :name :inc }
    (0x86 0x96 0xa6) { :name :dec }
    (0x87 0x97 0xa7) { :name :print_addr }
    (0x88 0x98 0xa8) { :name :call_1s }
    ...
    (0x8e 0x9e 0xae) { :name :load }
    (0x8f 0x9f 0xaf) { :name :not }
...
(defn instruction-table-extended [byte]
  (case byte
    ...
    (0x06) { :name :picture_data }
    (0x07) { :name :erase_picture }
    (0x08) { :name :set_margins }
    (0x09) { :name :save_undo }
    (0x0a) { :name :restore_undo }
